...
from accidentes.PKG1_Gestion_Accidentes.CU01_Registrar_Accidente.views import AccidenteDetalleView
from accidentes.PKG3_Consulta_Analisis.CU14_Solicitar_Expediente.views import AccidenteExpedienteView
