...
from accidentes.PKG5_Administracion.CU17_Gestionar_Unidades_Emergencia.services import UnidadEmergenciaGestionService
from accidentes.PKG5_Administracion.CU17_Gestionar_Unidades_Emergencia.serializers import (
...
class UnidadEmergenciaListCreateView(APIView):
    ...
    def get(self, request):
        ...
        unidades = UnidadEmergenciaGestionService.listar_unidades(tipo)
    ...
    def post(self, request):
        ...
        try:
            unidad = UnidadEmergenciaGestionService.crear_unidad(
                ...
                serializer.validated_data['tipounidademergencia'],
            )
